...
<html lang="ko">
	<head>
		...
		<meta name="description"
			  content="네이버 예약, 네이버 예약이 연동된 곳 어디서나 바로 예약하고,
			  네이버 예약 홈(나의예약)에서 모두 관리할 수 있습니다.">
		<meta name="viewport"
	...
	<body>
			...
			<div class="event">
				...
				<div class="section_event_lst">
					<p class="event_lst_txt">
						바로 예매 가능한 행사가 <span class="pink"><!-- Product 갯수 --></span>있습니다
					</p>
					<div class="wrap_event_box">
						<!-- [D] lst_event_box 가 2컬럼으로 좌우로 나뉨,
						더보기를 클릭할때마다 좌우 ul에 li가 추가됨 -->
		...
		<footer>
			...
			<div class="footer">
				<p class="dsc_footer">
					네이버(주)는 통신판매의 당사자가 아니며,
					상품의정보, 거래조건, 이용 및 환불 등과 관련한 의무와 책임은
					각 회원에게 있습니다.
				</p>
		...
		<!-- Promotion Template -->
		<script id="template-promotion-item" type="text/template">
			<li class="item"
				style="background-size:cover; background-image: url(http://localhost:8080/{productImageUrl});">
				<a href="#">
		...
		<!-- Category Template -->
		<script id="template-category-item" type="text/template">
