...
<html lang="ko" class="no-js" >
	<head>
		...
		<link rel="stylesheet" href="provided/reservation.v1.5/reservation.v1.5/resevation-html-base/css/bookinglogin.css">
	</head>
	<body class="biz  ko" >
		...
		<app>
			<toast-alert class="top_info hide booking_alert">
				...
				<a href="provided/reservation.v1.5/reservation.v1.5/resevation-html-base/htmls/mainpage.html" class="top_info_close" data-tst_alt_close="0"> <i class="fn fn-close" aria-hidden="true"></i> <span class="sr_only" translate="CM-CLOSE">닫기</span> </a>
			</toast-alert>
			<!---->
			<div class="_view_content" ui-view="content" id="container" >
				<booked-confirm>
					<div class="booking_login">
						<h1 class="login_header"> <a href="provided/reservation.v1.5/reservation.v1.5/resevation-html-base/htmls/mainpage.html" class="nbooking_logo spr_bi txt_logo" > <span translate="CM-NBOOKING">네이버 예약</span> </a> </h1>
						<!---->
						<div >
							<form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="provided/reservation.v1.5/reservation.v1.5/resevation-html-base/htmls/myreservation.html">
