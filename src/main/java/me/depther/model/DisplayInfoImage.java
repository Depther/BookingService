...
public class DisplayInfoImage {
	...
	public DisplayInfoImage(String contentType, String createDate,
							boolean deleteFlag, int displayInfoId,
							int displayInfoImageId, int fileId,
							String fileName, String modifyDate,
							String saveFileName) {
